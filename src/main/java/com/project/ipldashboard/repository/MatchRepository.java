...
public interface MatchRepository extends CrudRepository<Match, Long> {
    ...
    List<Match> getByTeam1OrTeam2OrderByDateDesc(String teamName1, String teamName2, Pageable pagebale);
    ...
    // teamName1,LocalDate date1,LocalDate date2,String teamName2,LocalDate
    // date3,LocalDate date4);

    default List<Match> findLastestMatchesByName(String teamName, int count) {
